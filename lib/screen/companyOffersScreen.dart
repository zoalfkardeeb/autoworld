...
class CompanyOffersScreen extends StatefulWidget {
  const CompanyOffersScreen({Key? key}) : super(key: key);
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                          child: _m!.cardOffers(curve,logo: _foundOffers[index]['supplier']['user']['imagePath'], toolImage: _foundOffers[index]['offerImg'],toolName: lng==2?_foundOffers[index]['arTitle']:_foundOffers[index]['title'],companyName: _foundOffers[index]['supplier']['fullName']),
  ...
  _selectCard(index) async{
    if(guestType){
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => CompanyOfferDetails(index),
          ));
    }
  }
